...
function EmployeeList() {
    ...
    useEffect(() => {
        ...
        const employeelist = (async () => {
            let url = "http://localhost:5001/api/employee/get"
            ...
            try {
                ...
                setMsg('Employee Fetched Successfully!!!!')
            }
            catch (error) {
                setMsg('Error in Fetch')
                console.error(error)
            }
        });
        employeelist();
